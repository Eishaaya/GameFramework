...
//          : base(image, location, color, rotation, effects, origin, scale, depth, ((AnimationFrame[][])totalframes[EnemyState.Idle])[0], time, true, false, Origins == null ? null : Origins[(int)EnemyState.Idle][0])
//        {
//            moveType = movetype;
